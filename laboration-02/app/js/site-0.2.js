var MessageBoard = {
    ...
    getAllMessages:function() {
        ...
        $.ajax({
			type: "POST",
			url: "get.php",
			data: {function: "getAllMessages", CSRFtoken: CSRFtoken},
    ...
    getNewMessages: function() {
        ...
        $.ajax({
			type: "POST",
			url: "get.php",
			data: {function: "getNewMessages", CSRFtoken: CSRFtoken, timestamp: timestamp},
			success: function(data) { // called when the AJAX call is ready
				if (data != "") {
					data = JSON.parse(data);
					for(var mess in data) {
    ...
    sendMessage:function(){
        ...
        $.ajax({
			type: "POST",
		  	url: "post.php",
		  	data: {CSRFtoken: CSRFtoken, name: name, message: message}
		}).done(function(data) {
			$("#inputText").val("");
		});
